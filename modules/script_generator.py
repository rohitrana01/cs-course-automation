...
Calls the Gemini or Anthropic Claude API to generate a structured script
...
Module: {topic['module']}
Level: {topic['level']}
Day: {topic['day']} of a 100-day {NICHE} course

IMPORTANT: Return ONLY valid JSON — no markdown, no code fences, no explanation.

The JSON must match this exact structure:
{{
  "video_title": "Day {topic['day']}: {topic['title']} | {NICHE} Course",
  "video_description": "In today's 5-minute lesson we cover {topic['title']}. Part of our free 100-day {NICHE} course from basics to advanced.\\n\\nTopics covered:\\n- [list 3-4 bullet points]\\n\\n#LearnCS #ComputerScience #Coding",
